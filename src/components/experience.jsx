...
const timeline = [
  {
    ...
    description:
      'Graduated with a Bachelor of Science in Information Systems, gaining expertise in web development, database management, software engineering, and information systems design through academic projects and hands-on development experience.',
    type: 'education',
    status: 'live',
    cert: null,
  },
  {
    ...
    description:
      'Assisted the IT department with day-to-day operations. Used free time productively for self-learning web development — turning downtime into growth time.',
    type: 'work',
    status: 'live',
    cert: null,
  },
  {
    ...
    description:
      'Completed a foundational course covering cybersecurity principles, threat awareness, and best practices in digital security.',
    type: 'certificate',
    status: 'live',
  ...
  },
  {
    ...
    description:
      'Participated in a DOLE-prescribed mandatory seminar on workplace safety, health regulations, and occupational hazard awareness.',
    type: 'certificate',
    status: 'live',
    cert: '/OSH.png',
  },
  {
    ...
    place: 'Certificate of Completion — Cisco Networking Academy',
    description:
      'Completed a structured course on HTML fundamentals — semantic markup, document structure, forms, and modern best practices.',
    type: 'certificate',
    status: 'live',
  ...
  return (
    ...
    >
      ...
      <div style={{ overflow: 'hidden', marginBottom: '5rem' }}>
        ...
        >
          My{' '}
          <span style={{ color: '#c8a96e', fontStyle: 'italic' }}>journey.</span>
        </motion.h2>
      </div>
